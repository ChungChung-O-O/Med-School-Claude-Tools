...
```
/Users/austin_cheng/Desktop/Agent/Claude_For_School/NotebookLM/
```
...
> **To upload:** Open NotebookLM → your notebook → Sources → Upload → select the `.txt` file from `Agent/Claude_For_School/NotebookLM/`.
